...
class CheckoutForm extends React.Component {
  ...
  handleSubmit = async event => {
    ...
    const {email, phone, name, error, cardComplete, amount} = this.state
...
const stripePromise = loadStripe(
  'pk_test_51Hunp9DchL2cGl0JPXE4R1onCDCeHFL1HZuIZH2wXycdaeKIbttFN322uSKGAx0eGJmc0RYRp1JRQV795pvCqSje00wV7c1Se9'
)

const App = () => {
  return (
    <div className="AppWrapper" style={{marginTop: '30%'}}>
